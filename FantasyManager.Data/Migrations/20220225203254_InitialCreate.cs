        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Flag = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTeamSquads", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserTeamSquads_Players_PlayerId",
                        column: x => x.PlayerId,
                        principalTable: "Players",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserTeamSquads_UserTeams_UserTeamId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTeamSquads_PlayerId",
                table: "UserTeamSquads",
                column: "PlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_UserTeamSquads_UserTeamId",
                table: "UserTeamSquads",
                column: "UserTeamId");
        }
